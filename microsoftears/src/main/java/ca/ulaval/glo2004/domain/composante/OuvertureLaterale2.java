...
public class OuvertureLaterale2 extends Composante{
    ...
    public OuvertureLaterale2(RoulotteController parent, Pouce hauteur, Pouce largeur, PointPouce centre, Pouce rayonCourbure) {
        super(parent);
        ...
        this.setType(TypeComposante.OUVERTURE_LATERALE_2);
    }

    public OuvertureLaterale2(RoulotteController parent) {
        super(parent);
